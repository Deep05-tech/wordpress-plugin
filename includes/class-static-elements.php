  ...
  <button type="submit" style="width:100%;background:#0A3663;color:#ffffff;border:none;border-radius:50px;padding:16px;font-weight:700;font-size:0.98rem;cursor:pointer;margin-top:6px;">Request a Marketing Proposal</button>
    ...
    private function social_icons_html(): string
    {
        ...
        foreach ($socials as $s) {
            $html .= '<a href="' . esc_url($s['url']) . '" target="_blank" rel="noopener noreferrer" style="width:32px;height:32px;border-radius:50%;background:#0A3663;display:inline-flex;align-items:center;justify-content:center;text-decoration:none;transition:all 0.2s ease;" title="' . esc_attr($s['name']) . '">' . $s['icon'] . '</a>';
        }
        $html .= '</div>';
        return $html;
    }
